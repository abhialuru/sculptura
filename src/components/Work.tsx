...
function Work({ heading, description, year, src, sides }: WorkPropTypes) {
  return (
    <div className={`w-full flex ${sides}`}>
      <div className="w-[50%] h-[100vh] flex flex-col items-center justify-between py-10">
      ...
      <motion.div className="w-[50%] h-[100vh] bg-slate-200">
        <Image
