  ...
  return (
    ...
    >
      ...
      <div className="w-full md:w-[90%] lg:w-[70%] text-2xl md:text-4xl font-light">
        ...
        designers works closely with each client to create spaces that are not
        only beautiful but also functional and timeless. Whether you’re looking
        to refresh a room or transform your entire home, we bring your ideas to
        life with attention to detail and a commitment to excellence.
      </div>
    </section>
  );
}
